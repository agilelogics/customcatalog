<?php
namespace Agilelogics\Amqp\Helper;
...
class Amqp extends AbstractHelper
{
    ...
    {
        return (string) $this->scopeConfig->getValue('agilelogics_amqp/broker/host');
    }
    ...
    {
        return (int) $this->scopeConfig->getValue('agilelogics_amqp/broker/port');
    }
    ...
    {
        return (string) $this->scopeConfig->getValue('agilelogics_amqp/broker/user');
    }
    ...
    {
        return (string) $this->scopeConfig->getValue('agilelogics_amqp/broker/pass');
    }
    ...
    {
        return (string) $this->scopeConfig->getValue('agilelogics_amqp/broker/vhost');
    }
