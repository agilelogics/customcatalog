...
namespace Agilelogics\CustomCatalog\Model\ResourceModel\Eav;
...
{
    const MODULE_NAME = 'Agilelogics_Products';
    const KEY_IS_GLOBAL = 'is_global';
    const KEY_IS_STATIC = 'static';

    protected $_eventObject = 'attribute';
    protected static $_labels = null;
    protected $_eventPrefix = ProductsSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    protected function _construct()
    {
        $this->_init('Agilelogics\CustomCatalog\Model\ResourceModel\Attribute');
    }
